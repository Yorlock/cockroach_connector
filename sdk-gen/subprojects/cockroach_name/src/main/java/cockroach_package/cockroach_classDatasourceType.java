...
public class cockroach_classDatasourceType extends CustomFlightDatasourceType
{
    /**
     * An instance of the custom Apache Derby data source type.
     */
    public static final cockroach_classDatasourceType INSTANCE = new cockroach_classDatasourceType();

    /**
     * The unique identifier name of the data source type.
     */
    public static final String DATASOURCE_TYPE_NAME = "cockroach_name";
    private static final String DATASOURCE_TYPE_LABEL = "cockroach_label";
    private static final String DATASOURCE_TYPE_DESCRIPTION = "cockroach_description";

    public cockroach_classDatasourceType()
    {
        super();
