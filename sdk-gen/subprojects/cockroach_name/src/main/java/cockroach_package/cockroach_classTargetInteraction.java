...
public class cockroach_classTargetInteraction extends RowBasedTargetInteraction<cockroach_classConnector>
{
    protected cockroach_classTargetInteraction(cockroach_classConnector connector, CustomFlightAssetDescriptor asset)
    {
        super();
